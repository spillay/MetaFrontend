...
namespace Nop.Plugin.PW.SimplePayment.Validators;

public class SimplePaymentInfoValidator : BaseNopValidator<SimplePaymentInfoModel>
{
    public SimplePaymentInfoValidator(ILocalizationService localizationService)
    {
        //useful links:
        ...
        RuleFor(x => x.SmartCardNumber).NotEmpty().WithMessageAwait(localizationService.GetResourceAsync("Payment.SmartCardNumber.Required"));
